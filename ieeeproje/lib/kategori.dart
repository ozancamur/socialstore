...
import 'package:ieeeproje/urun_detay.dart';
...
class _KategoriState extends State<Kategori> {
    ...
    return GestureDetector(
      onTap: (){
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.grey.withOpacity(0.2), //şeffaflık
              blurRadius: 4.0, //bulanıklaştırma yarıçapı
              spreadRadius: 2.0,  //yayılma yarıçapı, arttıkça gölge o kadar geniş alana yayılır
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      crossAxisCount: 2, //crossAxisCount yatay eksende kaç parçaya böleceğini belirler.
      mainAxisSpacing: 12.0, //üstüste duran elemanlar arasında boşluk belirler
      crossAxisSpacing: 12.0,//yanyana duran elemanlar arasında boşluk belirler
      padding: EdgeInsets.all(10.0),
      childAspectRatio: 1,//1 = eni boyuna eşit olsun yani kare 
      //en boy oranı demektir // 2 = eni boyunun 2 katı olurdu
